      ...
      <div className="flex items-center justify-between px-2">
        {links.map((link) => (
          ...
          >
            <div
              className={cn(
                "flex h-10 w-10 items-center justify-center rounded-full border border-slate-700 bg-slate-800 text-slate-300 transition-all",
                link.hoverColor,
                link.hoverBorder
              )}
            >
            ...
            <span className="text-[10px] font-bold uppercase tracking-wide text-slate-500 group-hover:text-slate-300">
              {link.name}
            </span>
          </a>
        ))}
